...
class ResponsibleController extends Controller
{
    ...
    public function store(ResponsibleRequest $request)
    {
        ...
        return redirect()->route('responsibles.index')->with('success', 'Responsable creado exitosamente.');
    }
    ...
    public function update(ResponsibleRequest $request, int $id)
    {
        ...
        return redirect()->route('responsibles.index')->with('updated', 'Responsable actualizado exitosamente.');
    }
    ...
    public function destroy(int $id)
    {
        $responsibles = Responsible::find($id);
        $responsibles->delete();
        return redirect()->route('responsibles.index')->with('deleted', 'Responsable eliminado exitosamente.');
    }
}
